...
JuceqAudioProcessorEditor::JuceqAudioProcessorEditor(JuceqAudioProcessor &p)
...
void JuceqAudioProcessorEditor::resized() {
...
void JuceqAudioProcessorEditor::parameterValueChanged(int parameterIndex, float newValue) {
